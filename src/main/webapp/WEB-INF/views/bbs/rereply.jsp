...
<script>
	...
	rereply_str += '    <a class="rrclose badge  badge-light mr-1">취소</a>';
	rereply_str += '    <a class="rrreply badge  badge-info mr-3">댓글</a>';
	rereply_str += '</div>';
	rereply_str += '</div>';
	...
	replyModify_str += '    <a class="rrclose badge  badge-light mr-1">취소</a>';
	replyModify_str += '    <a class="rrmodify badge  badge-info mr-3">수정</a>';
	replyModify_str += '</div>';
	replyModify_str += '</div>';
	// 대댓글 수정 html코드 끝----------------------------------
				...
				success:function(result){		
					$.each(result.item,function(idx, rec){
						...
						if(rec.rindent == 0){
							...
							str += '  <div class="col-1">';
							str += '    <img src="${pageContext.request.contextPath }/resources/img/face.png"';
							str += '         class="rounded-cicle" style="width:45px"'; 
							str += '         alt="" />';
							str += '  </div>';
							str += '  <div class="col-11">';
							str += '    <h6><b>'+rec.rnickname+'('+rec.rid+')</b>' +'<small class="ml-2"><i>'+rec.rcdate+'</i></small></h6>';
							...
							str += '    <a class="rereplyBtn badge  badge-info"><i>댓글</i></a>';
							str += '  </div>';															
						}else{
						...
						if(l_id == rec.rid){
							...
							str += '    <a class="reModifyBtn badge  badge-warning">수정</a>';
							str += '    <a class="replyDelBtn badge  badge-danger">삭제</a>';
							str += '  </div>';	
						}
						str += '</div>';	
						str += '</div>';	
  ...
  <div class="row justify-content-end my-1">
		<div class="col col-sm-1 px-0 m-1">
     	<button class="btn btn-sm btn-outline-info btn-block" id="replyCancleBtn">취소</button>
    </div>
		<div class="col col-sm-1 px-0 m-1">
     	<button class="btn btn-sm btn-outline-info btn-block" id="replyBtn2">등록</button>
    </div>
  </div>
	...
	<div class="row">
		<div id="replyList" class="col m-0 p-0">
			...
			<div class="row m-2 p-0">
				<div class="col-1">
					<img src="${pageContext.request.contextPath }/resources/img/face.png"
			...
			<div class="row m-0 p-0">
				...
				<div class="col-8">
					...
					<a class="badge  badge-info"><i>댓글</i></a>
				</div>		
				<div class="col-3 text-right">
					<a class="badge badge-warning">수정</a>
					<a class="badge badge-danger">삭제</a>
				</div>	
			</div>	
		  ...
		  <div class="row justify-content-end my-1 mr-0">
					<a class="badge badge-light mr-1">취소</a>
					<a class="badge badge-info mr-3 ">댓글</a>
		  </div>
		  ...
		  <div class="row justify-content-end my-1 mr-0">
					<a class="badge badge-light mr-1">취소</a>
					<a class="badge badge-info mr-3">수정</a>
		  </div>
			...
			<div class="row m-0 p-0">
				...
				<div class="col-3 text-right">
					<a class="badge badge-warning">수정</a>
					<a class="badge badge-danger" id="deleteBtn">삭제</a>
				</div>	
			</div>
