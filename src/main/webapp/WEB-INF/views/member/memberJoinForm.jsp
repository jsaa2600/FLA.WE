...
(function(){
    ...
    // 비밀번호 체크 : 6~10이하, 소문자,숫자,대문자,특수문자가 들어가는 비밀번호		
      ...
      if(status) {
    	  ...
    	  validFeedback(genderTag[0].parentElement.parentElement.parentElement,status,"성별 선택하세요!");
      }		
      ...
      <form:form modelAttribute="mdto" action="${pageContext.request.contextPath }/member/memberJoin">
        ...
        <div class="form-row">
          <div class="col-sm-12 mb-1">
            ...
            <form:password cssClass="form-control form-control-sm " path="pw" placeholder="비밀번호는 6자리이상" required="required"/>
        ...
        <div class="form-row">
          <div class="col-sm-12 mb-1">
            ...
            <input type="password" class="form-control form-control-sm " id="pwchk" name="pwchk" placeholder="" required="required"/>
            <div class=""></div>
          </div>
        </div> 
        <div class="form-row">
          <div class="col-sm-12 mb-1">
            ...
            <form:input type="text" cssClass="form-control form-control-sm " path="tel" placeholder="'-'포함 입력하세요" required="required"/>
        ...
        <div class="form-row">
          <div class="col-sm-12 mb-1">
	          <div><label for="gender" class="col-form-label-sm my-0 py-1 mr-3">성별</label></div>
						<div class="col btn-group btn-group-toggle border rounded p-0 m-0" data-toggle="buttons">
						  <label class="btn btn-sm btn-light border-white">
        ...
        <div class="form-row">
          <div class="col-sm-12 mt-5">
          	<button class="btn btn-info btn-block" type="submit" id="joinBtn">가입하기</button>
          </div>
        </div>        
      </form:form>    
    	</div>
